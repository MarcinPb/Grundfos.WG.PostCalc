...
namespace WpfApplication1.Ui.WbEasyCalcData
{
    public class EditedViewModel : ViewModelBase, IDialogViewModel
    {
        ...
        public string Title { get; set; } = "WBEasyCalc Dialog";
        public bool Save()
        {
            var model = GlobalConfig.DataRepository.WbEasyCalcDataListRepository.SaveItem(Model.Model);
            return true;
        }

        public void Close()
        {
            //_repo.ParentRepo.RepoChanged -= OnServiceRepoChanged;
        }
