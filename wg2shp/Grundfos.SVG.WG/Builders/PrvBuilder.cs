...
namespace Grundfos.SVG.WG.Builders
{
    public class PrvBuilder : IVisualElementBuilder
    {
        ...
        protected virtual List<SvgPath> BuildPaths(Prv item)
        {
